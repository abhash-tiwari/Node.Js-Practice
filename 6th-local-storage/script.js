...
// for an error msg if we did not write or something like this fiels is required
...
// so we have taken the elements now we start implementing our js functionality
...
function validation(payload) {
  ...
  nameElement.addEventListener("focus", () => {
    console.log("name focused"); // Log a message to the console
    nameInfoElement.innerHTML = ""; // Clear any previous error messages in the nameInfoElement
  });
  // VALIDATION
  ...
  form.addEventListener("submit", (event) => {
    ...
    if (resultOfValidaion) {
      fetch("https://www.google.com", { method: "POST", body: JSON.stringify(payload) });
    } else {
  ...
  /////////////////////// Now start the Local Storage Code //////////////////////
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const { name, email ,doctor} = payload;
    console.log("DOMContentLoaded", name, email, doctor);
